                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm">0-1 (Minor)</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 rounded-full bg-[#F1C40F]"></div>
                                <span className="text-sm">1-2 (Light)</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 rounded-full bg-[#E67E22]"></div>
                                <span className="text-sm">2-3 (Moderate)</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 rounded-full bg-[#E74C3C]"></div>
                                <span className="text-sm">3-4 (Strong)</span>
                            </div>
                            <div className="flex items-center gap-2">
