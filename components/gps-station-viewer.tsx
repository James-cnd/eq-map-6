        ...
        >
            ...
            >
                <div className="space-y-4">
                    ...
                    <div className="border-t border-gray-700 pt-4">
                        <h3 className="font-semibold mb-2">Station Data</h3>
                        {station.url ? (
                            <iframe
                                src={station.url}
                                className="w-full h-64 bg-white rounded"
                                title={`GPS data for station ${station.id}`}
                                sandbox="allow-same-origin allow-scripts allow-popups allow-forms"
                                referrerPolicy="no-referrer"
                            />
                        ) : (
                            <div className="bg-gray-800 p-4 rounded text-center">
                                <p>No data URL available for this station</p>
                                <p className="text-sm text-gray-400 mt-2">Add a URL in the admin panel to enable data visualization</p>
                            </div>
                        )}
                    </div>
                </div>
